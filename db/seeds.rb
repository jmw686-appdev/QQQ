...
resource = Resource.find_or_create_by(
  ...
  context_id: context.id,
  title: "#{Rails.application.class.parent} (dev)"
)
puts 'Add Resource'
...
Launch.find_or_create_by(
  ...
  payload:
   { 'roles' => 'Instructor',
     ...
     'resource_link_title' => "#{Rails.application.class.parent} (dev)",
     ...
     'custom_canvas_assignment_title' => "#{Rails.application.class.parent} (dev)",
