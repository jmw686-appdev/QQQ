class ResponsesController < ApplicationController
  ...
  private
    ...
    def response_params
      params.require(:response).permit(:body, :enrollment_id, :question_id, :anonymous_to_all, :anonymous_to_students, :parent_id, :marked_as_answer, :marked_good_by_instructor)
    end
end
